...
export default function DcMotorSimulation() {
  ...
  useEffect(() => {
    ...
    const updateUI = () => {
      ...
      if(ui.telem.current) {
        ui.telem.current.textContent = `V=${p.V.toFixed(1)}V  I=${S.current.toFixed(2)}A  ε=${S.backEmf.toFixed(2)}V  ω=${(S.omega * 9.549).toFixed(0)}rpm`;
      }
    };
      ...
      <div className="app">
            ...
            <div className="params">
              ...
              <div className="param-row">
                <div className="param-head">
                  <span className="param-label">Supply voltage</span>
              ...
              <div className="param-row">
                <div className="param-head">
                  <span className="param-label">Load torque</span>
              ...
              <div className="param-row">
                <div className="param-head">
                  <span className="param-label">Field strength</span>
        ...
        <div className="chart-row">
          <div className="chart-card">
            <div className="chart-label">Torque–speed curve &amp; operating point</div>
