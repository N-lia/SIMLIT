      ...
      <div className="sim-card">
        ...
        <div className="flex-dashboard">
          <div className="controls">
            <div className="ctrl-group">
              ...
              <div className="param-row" style={{ marginTop: '8px' }}>
                <span>Length <KaTeX math="L" /> (m):</span>
            ...
            <div className="ctrl-group">
              ...
              <div className="param-row">
                <span><KaTeX math="E" /> (GPa):</span><input type="number" value={E_GPa} onChange={e => setE_GPa(Number(e.target.value))} step="5" style={{ width: '80px' }} className="num-input" />
                <span><KaTeX math="\sigma_y" /> (MPa):</span><input type="number" value={yield_MPa} onChange={e => setYield_MPa(Number(e.target.value))} step="10" style={{ width: '80px' }} className="num-input" />
              </div>
              ...
              <div className="badge" style={{ marginTop: '8px', textAlign: 'center' }}><KaTeX math={`I=${(section.I * 1e8).toFixed(1)}\\,\\mathrm{cm^4}`} /></div>
            </div>
          ...
          <div className="visualization">
            ...
            <div className="legend"> Stress distribution <KaTeX math="\sigma=\frac{My}{I}" /> (tension + compression)</div>
