...
export default function StressStrainSimulation() {
  ...
  useEffect(() => {
    ...
    function updateFromForce() {
        ...
        if (readoutSpan) readoutSpan.innerHTML = renderKaTeXString(`\\sigma=${stressMpa}\\,\\mathrm{MPa}\\quad |\\quad \\varepsilon=${strainVal}\\quad |\\quad E_{sec}=${E_inst.toFixed(1)}\\,\\mathrm{GPa}`);
        if (failureDiv) {
      ...
      <div className="sim-card">
        ...
        <div className="flex-dashboard">
          <div className="controls">
            ...
            <div className="control-group">
              <label> Specimen: <KaTeX math="L_0" /> (mm) / <KaTeX math="A" /> (mm²)</label>
