...
export default function MohrsCircleSimulation() {
  ...
  useEffect(() => {
    ...
    function update() {
        ...
        if (principalDisplay) principalDisplay.innerHTML = renderKaTeXString(`\\sigma_1=${sigma1.toFixed(1)}\\,\\mathrm{MPa}\\quad \\sigma_2=${sigma2.toFixed(1)}\\,\\mathrm{MPa}\\\\ \\tau_{max}=${tauMax.toFixed(1)}\\,\\mathrm{MPa}\\quad |\\quad \\theta_p=${thetaP_deg.toFixed(1)}^\\circ`, true);
        if (rotatedDisplay) rotatedDisplay.innerHTML = renderKaTeXString(`\\sigma_x'=${rotated.sigmax_prime.toFixed(1)}\\,\\mathrm{MPa}\\quad \\sigma_y'=${rotated.sigmay_prime.toFixed(1)}\\,\\mathrm{MPa}\\quad \\tau_{xy}'=${rotated.tauxy_prime.toFixed(1)}\\,\\mathrm{MPa}`, true);
        ...
        <div className="flex-dashboard">
          <div className="controls">
            <div className="control-group">
              <label> Normal stress <KaTeX math="\sigma_x" /> (MPa)</label>
            ...
            <div className="control-group">
              <label> Normal stress <KaTeX math="\sigma_y" /> (MPa)</label>
            ...
            <div className="control-group">
              <label> Shear stress <KaTeX math="\tau_{xy}" /> (MPa)</label>
            ...
            <div className="control-group">
              <label> Element rotation angle <KaTeX math="\theta" /> (degrees)</label>
            ...
            <div className="control-group">
              ...
              <div style={{fontSize: '0.7rem'}}>(<KaTeX math="\sigma" /> positive → right/up, negative → left/down)</div>
          ...
          <div className="visualization">
            ...
            <div className="legend">
              ...
              <span> Principal stresses (<KaTeX math="\sigma_1,\sigma_2" />)</span>
              <span> Max shear (<KaTeX math="\tau_{max}" />)</span>
              <span> Current stress state (<KaTeX math="\sigma_x,\tau_{xy}" />) &amp; rotation</span>
            </div>
            ...
            <div className="legend" style={{marginBottom: 0}}>
              <span> Stress element (rotated by <KaTeX math="\theta" />)</span>
