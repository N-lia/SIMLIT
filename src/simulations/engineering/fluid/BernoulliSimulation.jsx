...
export default function BernoulliSimulation() {
  ...
  useEffect(() => {
    ...
    function drawSimulation(data) {
      ...
      ctx.font = "12px 'Outfit', 'Segoe UI', system-ui";
      ctx.lineWidth = 1.8;
      ...
      ctx.closePath();
      ctx.fillStyle = "rgba(47, 93, 136, 0.13)";
      ctx.fill();
      ...
      for (let i = 0; i < 3; i++) {
        ...
        // background
        ctx.fillStyle = "rgba(255, 244, 223, 0.68)";
      ...
      // dynamic annotations
      ctx.font = "500 10px 'Outfit', 'Segoe UI'";
      ctx.fillStyle = colors.blue;
  ...
  return (
    <div className="bernoulli-wrapper" ref={rootRef}>
      <div className="sim-card">
        <h1> Bernoulli Flow Simulator <small><KaTeX math="P + \frac{1}{2}\rho v^2 + \rho g h" /> along a streamline</small></h1>
        <div className="sub">
        ...
        <div className="dashboard">
          ...
          <div className="controls">
            ...
            <div className="control-group">
              ...
              <div className="mode-note"> Real mode: head losses (K≈0.28 per segment) reduce total pressure</div>
            </div>
          ...
          <div className="visualization">
            <div className="canvas-container">
              ...
              <div className="legend">
                <span style={{color: 'var(--accent-blue)'}}>⬤ Pressure gauge</span>
                <span> Velocity arrows (size = speed)</span>
                <span> Energy per mass: <span className="legend-chip pressure"><KaTeX math="\frac{P}{\rho}" /></span> <span className="legend-chip kinetic"><KaTeX math="\frac{1}{2}v^2" /></span> <span className="legend-chip potential"><KaTeX math="gz" /></span></span>
