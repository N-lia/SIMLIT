      ...
      <div className="sim-container">
        ...
        <div className="dashboard">
          <div className="controls-panel">
            ...
            <div className="control-group">
              <label> Roughness <KaTeX math="\varepsilon" /> (mm)</label>
            ...
            <div className="control-group" style={{background: '#e0f2fe', padding: '12px', borderRadius: '12px', border: '1px solid #bae6fd'}}>
              <label style={{color: '#0369a1'}}> Flow Rate <KaTeX math="Q" /> (m³/h) [Calculated]</label>
            ...
            <div className="control-group">
              <label> Fluid Viscosity <KaTeX math="\nu" /> (cSt)</label>
          ...
          <div className="viz-panel">
            ...
            <div className="legend">
              ...
              <span> <strong>Reynolds:</strong> <KaTeX math="\mathrm{Re}" /> <span id="reDisplay" className="reynolds">---</span></span>
            ...
            <div style={{fontSize: '0.7rem', textAlign: 'center', marginTop: '6px'}}>
               System curve vs pump curve — operating point from <KaTeX math="H_{\mathrm{pump}}(Q)=H_{\mathrm{system}}(Q)" />
            </div>
          </div>
        </div>
      </div>
