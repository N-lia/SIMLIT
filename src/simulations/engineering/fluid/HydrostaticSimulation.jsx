...
export function mountHydrostaticSimulation(container) {
  ...
  const root = htmlToElement(`
    <div class="hydrostatic-wrapper">
      <div class="sim-card">
        <h1> Hydrostatic Pressure Simulator <small>${ktex('P=P_0+\\rho gh')} | Force on submerged surfaces</small></h1>
        ...
        <div class="flex-dashboard">
          <div class="controls">
            <div class="control-group">
              ...
              <div class="fluid-select" id="fluidGroup">
                <label><input type="radio" name="fluid" value="water" checked />  Water ${ktex('\\rho=1000\\,\\mathrm{kg\\,m^{-3}}')}</label>
                <label><input type="radio" name="fluid" value="oil" />  Oil ${ktex('\\rho=850\\,\\mathrm{kg\\,m^{-3}}')}</label>
                <label><input type="radio" name="fluid" value="mercury" />  Mercury ${ktex('\\rho=13546\\,\\mathrm{kg\\,m^{-3}}')}</label>
              </div>
              <div class="param-row" style="margin-top: 8px;">
                <div class="param">Custom ${ktex('\\rho\\,(\\mathrm{kg\\,m^{-3}})')}: <input type="range" id="customRho" min="200" max="20000" step="10" value="1000" disabled /></div>
            ...
            <div class="control-group">
              ...
              <div class="toggle-switch">
                <label><input type="radio" name="atm" value="include" checked /> Include ${ktex('P_{\\mathrm{atm}}=101.3\\,\\mathrm{kPa}')}</label>
          ...
          <div class="visualization">
            ...
            <div class="legend-row" style="justify-content: center;">
              <span> Pressure vs Depth (linear: ${ktex('P=P_0+\\rho gh')})</span>
            </div>
          </div>
        </div>
      </div>
  ...
  function enableCustom() {
    ...
    if (!customRad) {
      ...
      customLabel.innerHTML = `<input type="radio" name="fluid" value="custom" id="customFluidRadio">  Custom ${ktex('\\rho')}`
