...
export function mountNewtonsLawSimulation(container) {
  ...
  const root = htmlToElement(`
    <div class="newton-wrapper">
      <div class="sim-card">
        <h1> Newton's 2nd Law Simulator <small>${ktex('F=ma')} Interactive</small></h1>
        ...
        <div class="flex-dashboard">
          <div class="controls">
            ...
            <div class="control-group">
              <label><span class="var-m">Mass ${ktex('m')}</span></label>
            ...
            <div class="control-group" data-group-calcF>
              <label><span class="var-a">Acceleration ${ktex('a')}</span></label>
            ...
            <div class="control-group" data-group-calcA style="display:none;">
              <label><span class="var-f">Force ${ktex('F')}</span></label>
  ...
  function updateFormula() {
    ...
    if (mode === 'calcF') {
      formulaBox.innerHTML = ktex(`F = ma = (${mass}\\,\\mathrm{kg})(${acceleration}\\,\\mathrm{m\\,s^{-2}}) = ${force.toFixed(1)}\\,\\mathrm{N}`)
    } else {
      formulaBox.innerHTML = ktex(`a = \\frac{F}{m} = \\frac{${force}\\,\\mathrm{N}}{${mass}\\,\\mathrm{kg}} = ${acceleration.toFixed(2)}\\,\\mathrm{m\\,s^{-2}}`)
    }
  }
