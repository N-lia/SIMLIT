        ...
        <aside class="vector-side">
          ...
          <section class="vector-card vector-result">
            ...
            <div class="vector-result-grid">
              <div><span>${ktex('x')}</span><strong data-result-x></strong></div>
              <div><span>${ktex('y')}</span><strong data-result-y></strong></div>
              <div><span>${ktex('|\\mathbf{R}|')}</span><strong data-result-mag></strong></div>
              <div><span>${ktex('\\theta')}</span><strong data-result-angle></strong></div>
            </div>
          </section>
          ...
          <section class="vector-card vector-note">
            ...
            <p>${ktex('(x,y)')}, ${ktex('[x,y]')}, ${ktex('\\langle x,y\\rangle')}, ${ktex('3\\mathbf{i}+2\\mathbf{j}')}, scalar multiplication, and named vectors.</p>
          </section>
        </aside>
      </section>
    </div>
