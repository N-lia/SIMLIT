  ...
  useEffect(() => {
    ...
    const drawMain = (s, p, t) => {
      ...
      if (t.showTrails) {
        for (let i = 0; i < N_FAN; i++) {
          ...
          ctx.strokeStyle = t.showFan ? fanColor(i, 0.45) : 'rgba(57,255,138,0.5)';
      ...
      grad1.addColorStop(0, '#e8f8ff');
      grad1.addColorStop(1, 'rgba(0,212,255,0.6)');
      ...
      grad2.addColorStop(1, 'rgba(57,255,138,0.7)');
      ctx.beginPath(); ctx.arc(mp.x2, mp.y2, r2, 0, Math.PI*2);
      ctx.fillStyle = grad2; ctx.fill();
      ctx.strokeStyle = 'rgba(57,255,138,0.5)'; ctx.lineWidth = 1; ctx.stroke();

      ctx.beginPath(); ctx.arc(mp.x2, mp.y2, r2+5, 0, Math.PI*2);
      ctx.fillStyle = 'rgba(57,255,138,0.06)'; ctx.fill();
      ...
      if (t.showFan && s.states.length > 1) {
        ...
        if (sep > 2) {
          ...
          ctx.strokeStyle = `rgba(255,77,77,${Math.min(0.8, sep/80)})`;
    ...
    const drawPoincare = (s, t) => {
      ...
      for (let j = 0; j < s.poincPts.length; j++) {
        ...
        ctx.fillStyle = chaos ? 'rgba(255,77,77,0.8)' : 'rgba(255,184,48,0.75)';
        ctx.fill();
      }
    ...
    const drawEnergyChart = (s, t) => {
      ...
      plotLine(s.energyHistory.map(e => e.ke), 'rgba(0,212,255,0.75)');
      plotLine(s.energyHistory.map(e => e.pe), 'rgba(57,255,138,0.65)');
      plotLine(s.energyHistory.map(e => e.e),  'rgba(255,184,48,0.9)');

      ctx.font = '9px IBM Plex Mono, monospace';
      ctx.fillStyle = 'rgba(0,212,255,0.8)';   ctx.fillText('KE', pad.l+4, pad.t+12);
      ctx.fillStyle = 'rgba(57,255,138,0.8)';  ctx.fillText('PE', pad.l+28, pad.t+12);
      ctx.fillStyle = 'rgba(255,184,48,0.9)';  ctx.fillText('E',  pad.l+52, pad.t+12);
      ...
      <div className="app">
        <div className="main-grid">
          ...
          <div className="right-col">
            <div className="ctrl-panel">
              ...
              <div className="param-row">
                <div className="param-head">
                  <span className="param-label">θ₁ — upper angle</span>
              ...
              <div className="param-row">
                <div className="param-head">
                  <span className="param-label">θ₂ — lower angle</span>
              ...
              <div className="param-row">
                <div className="param-head">
                  <span className="param-label">m₁ — upper mass</span>
              ...
              <div className="param-row">
                <div className="param-head">
                  <span className="param-label">m₂ — lower mass</span>
              ...
              <div className="param-row">
                <div className="param-head">
                  <span className="param-label">L₁ — upper length</span>
              ...
              <div className="param-row">
                <div className="param-head">
                  <span className="param-label">L₂ — lower length</span>
              ...
              <div className="param-row">
                <div className="param-head">
                  <span className="param-label">g — gravity</span>
            ...
            <div className="readout-grid">
              ...
              <div className="readout">
                <div className="readout-label">E drift</div>
                <div className="readout-val" ref={uiRef.driftOut}>0.000%</div>
              </div>
              <div className="readout">
                <div className="readout-label">ω₂ (rad/s)</div>
        ...
        <div className="bottom-row">
          <div className="chart-panel">
            <div className="chart-title">Poincaré Section — <span>θ₁=0 crossings</span></div>
